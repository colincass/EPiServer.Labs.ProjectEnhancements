...
Set-Location src\AlloyMvcTemplates\modules\_protected\episerver-labs-project-enhancements
ZipCurrentModule -moduleName episerver-labs-project-enhancements
Set-Location $workingDirectory
Start-Process -NoNewWindow -Wait -FilePath $nuget -ArgumentList "pack", "$workingDirectory\build\packaging\EPiServer.Labs.ProjectEnhancements.nuspec", "-Version $assemblyFileVersion", "-Properties configuration=Release", "-BasePath ./", "-Verbosity detailed"
